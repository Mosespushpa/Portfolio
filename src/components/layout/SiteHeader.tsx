...
import { Sparkles, Home, Lightbulb, Briefcase, Mail } from 'lucide-react'; // Using Sparkles as a generic logo icon
...
const navItems = [
  ...
  // Add { href: '/#achievements', label: 'Achievements' } when section exists
];
